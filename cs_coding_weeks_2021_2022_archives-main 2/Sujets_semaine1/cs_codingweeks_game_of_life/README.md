# CentraleSupélec Coding WEEKS : Le jeu de la vie de Conway

## Bienvenue aux Coding Weeks !
### Cet espace correspond au projet **jeu de la vie** de la première semaine des coding weeks.


Cette activité de deux semaines va vous permettre de monter en compétences en programmation et développement. 

A l'issue de cette période, vous serez en mesure de programmer le jeu de la vie de Conway.

Ce cours sera divisé en deux séquences. La première semaine sera dédiée à l'apprentissage des concepts utiles, par la pratique, en programmant le `gameoflife`. La seconde sera une semaine projet où vous développerez un jeu de votre choix.
...
- rejoindre l'équipe TEAMS de code **r4crxa2** 

- vous répartir par équipe de cinq et de noter votre équipe sur cet [classeur](https://centralesupelec.sharepoint.com/:x:/s/CS_Coding_Weeks_Game_of_Life/EeKSBw6ZCIdGk0_mGx992IkB0nYTQA_Y2nfoArEnbjD63Q?e=Wh8MFx),
...
- et rejoindre à minima les canaux `#cw_week1_game_of_life` et `#cw_important_informations`
 sur Slack.
...
Vous êtes maintenant prêts. C'est parti !


### Pour commencer, c'est [ici](./TemplateProject_jeudelavie.md)